...
const POST_META: Record<string, PostMeta> = {
  ...
  'andy-galpin-vo2max-training': { tags: ['video'], heroImage: 'andy-galpin-portrait.jpg' },
  'inigo-san-millan-zone-2': { tags: ['video'], heroImage: 'inigo-san-millan-portrait.jpg' },
  'rhonda-patrick-vo2max-tabata': { tags: ['video'], heroImage: 'rhonda-patrick-portrait.jpg' },
