---
title: "VO2Max and Weight Training: Can You Do Both?"
meta_description: "Does cardio kill gains? Does lifting hurt your VO2max? Here's what the science says about combining strength training and aerobic fitness effectively."
slug: "vo2max-and-weight-training"
---

# VO2Max and Weight Training: How to Do Both Without Sabotaging Either
...
This is why strength training is particularly important for VO2max after 40. It's not just about aesthetics or strength. Preserving muscle mass preserves the physical infrastructure that supports cardiovascular fitness. More on this in the [VO2max after 40 guide](/vo2max-after-40).
...
The team at Renaissance Periodization — exercise scientists with a strong resistance-training focus — takes a slightly different view. In their [critique of Andrew Huberman's workout program](https://youtube.com/watch?v=gpxxW5r9j70), they argue that for most people without endurance performance goals, lifting should be the clear priority and cardio should serve as a support tool.
...
| Day | Session |
|-----|---------|
| Monday | Upper body lifting (push: chest, shoulders, triceps) |
| Tuesday | 40–50 min zone 2 cardio (easy bike or walk) |
| Wednesday | Lower body lifting (squat, hinge, single-leg) |
| Thursday | Rest or 20 min easy walk |
| Friday | Upper body lifting (pull: back, biceps) + optional 10 min HIIT finisher |
| Saturday | 50–60 min zone 2 cardio (longer, easy) |
| Sunday | Rest |
...
Use the [VO2max calculator](https://vo2maxcalculators.com) to see where you actually stand — you might be better than you think.
...
For a specific VO2max protocol to add to your lifting week, the [10-minute workout guide](/10-minute-vo2max-workout) is the simplest starting point. And for the full story on zone 2 vs. HIIT — which type of cardio plays better with lifting — see [the debate breakdown](/zone-2-vs-hiit-debate).

---
## Suggested Image Prompts
1. A split-screen gym image: left side shows a person doing barbell squats with focused strength, right side shows the same person on a stationary bike doing intervals. Both depicted with equal energy and intensity. Clean gym environment, natural light.
2. A diagram showing a weekly training calendar with color-coded sessions: strength days (blue), zone 2 cardio (green), HIIT (red), rest (grey). Arrows showing recovery flow and how sessions complement each other. Clean planner-style infographic.
