---
title: "What Happens to Your VO2Max After 40 (And How to Fight Back)"
meta_description: "VO2max declines 8-10% per decade after 40 — but research shows it's highly trainable at any age. Here's exactly what changes and what you can do."
slug: "vo2max-after-40"
---

# What Happens to Your VO2Max After 40 — And How to Fight Back
...
Peter Attia has emphasized this in his [exercise for longevity work](https://youtube.com/watch?v=BSAX0KSNS_E): you don't need to become an elite athlete. You just need to not be in the bottom quartile.
...
The [full zone 2 guide featuring Iñigo San Millán](/inigo-san-millan-zone-2) is the best resource for understanding this properly.
...
In his [podcast on human performance](https://youtube.com/watch?v=bdrgVF4gi1E), he talks about what that transformation required — and what it means for what's possible in the second half of life.
...
| Day | Session |
|-----|---------|
| Monday | 40–50 min zone 2 (easy cycling or walking) |
| Tuesday | Strength training (30–40 min) |
| Wednesday | Rest or gentle walk |
| Thursday | Intervals: 4×4 (4 min hard / 4 min easy × 4 rounds) or Tabata |
| Friday | Strength training (30–40 min) |
| Saturday | 50–60 min zone 2 (easy, slightly longer) |
| Sunday | Rest |
...
If you don't know where you stand, [test your VO2max now](/test-vo2max-at-home). The Cooper Test (12-minute run) or the World Fitness Level calculator are both accessible options.

Then use our [VO2max calculator](https://vo2maxcalculators.com) to see where you stand for your age and sex. You might be better than you think. Or you might see clearly why the stairs have been feeling harder.

Either way, knowing is better than not knowing. And starting is better than waiting.

---
## Suggested Image Prompts
1. A fit man or woman in their mid-50s, clearly active and healthy, on a road bike in an autumn landscape — strong, vital, glowing with outdoor light. The image should make the viewer think "I want to look like that at that age." Real, not model-perfect.
2. A side-by-side diagram showing the VO2max decline curve for a sedentary person (steep downward slope) vs. an active person (gentle decline, maintaining significantly higher values through 60s, 70s). Clean medical infographic with motivating color coding.
