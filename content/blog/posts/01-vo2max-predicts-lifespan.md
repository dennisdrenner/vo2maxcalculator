---
title: "The Number That Predicts How Long You'll Live"
meta_description: "VO2max is the single strongest predictor of lifespan — stronger than smoking, cholesterol, or diabetes. Here's what it is and why it matters."
slug: "vo2max-predicts-lifespan"
---

# The Single Number That Predicts How Long You'll Live (And It's Not Cholesterol)
...
Dr. Andy Galpin, a professor of kinesiology who trains elite athletes and world champions, [summarizes this data clearly](https://youtube.com/watch?v=6XIoWlwUKU0): "There is no upper limit to VO2max benefits. The higher your VO2max, the higher your chance of survival continues to increase — with no diminishing returns."
...
Peter Attia MD, one of the leading voices on longevity medicine, talks about this in his [deep dive on exercise for longevity](https://youtube.com/watch?v=BSAX0KSNS_E): the floor matters more than the ceiling. Getting off the couch is the most powerful move most people can make.
...
If you're over 40, you'll want to read our guide on [what happens to VO2max after 40 — and how to fight back](/vo2max-after-40). And if you're wondering what level you're at right now, we've got [several ways to test your VO2max at home](/test-vo2max-at-home) without needing a lab.

## What Does Your VO2max Score Actually Mean?

Here's a rough guide by age and sex (ml/kg/min):

| Category | Men (40s) | Women (40s) |
|----------|-----------|-------------|
| Poor | < 35 | < 28 |
| Below average | 35–40 | 28–34 |
| Average | 40–45 | 34–39 |
| Good | 45–52 | 39–45 |
| Excellent | 52–60 | 45–53 |
| Elite | 60+ | 53+ |

These numbers shift a bit by age — a "good" VO2max at 60 looks different than at 30. Use our [VO2max calculator](https://vo2maxcalculators.com) to see where you stand for your specific age and sex.
...
You don't need hours a day. Research by Dr. Martin Gibala at McMaster University shows that [as little as 10–20 minutes of smart interval training](/10-minute-vo2max-workout) can match VO2max gains from much longer moderate workouts.

If you want a structured plan, check out [how to go from couch to the top 25% for your age](/couch-to-top-25-percent-vo2max). Or if you're short on time, the [10-second sprint method](/10-second-sprints-vo2max) is a surprisingly effective starting point.
...
1. A split-screen infographic showing two human figures: one sedentary with a dull gray heart icon, one active mid-run with a bright red glowing heart. Clean, modern health/medical illustration style with labels showing VO2max numbers and mortality risk percentages.
2. A bright, energetic photo of a middle-aged person (45-55) running outdoors on a trail at sunset, expression of focused joy, golden light. Shot from slightly below to make them look powerful and vital. Not a model — looks like a real person.
