---
title: "Insulin Resistance and VO2Max: The Hidden Connection"
meta_description: "Ben Bikman explains why insulin resistance tanks your VO2max at the cellular level — and how improving aerobic fitness can reverse it."
slug: "insulin-resistance-vo2max"
---

# Insulin Resistance Is Killing Your VO2Max — And Vice Versa
...
1. Insulin resistance → mitochondrial dysfunction
2. Mitochondrial dysfunction → lower aerobic capacity (lower VO2max)
3. Lower aerobic capacity → less fat oxidation → more insulin resistance
4. Go to step 1
...
Dr. Martin Gibala covers this in his [FoundMyFitness interview](https://youtube.com/watch?v=anzG6tVdjkQ), noting that HIIT specifically produces large improvements in GLUT4 expression — even in populations with metabolic disease.

### Zone 2 and Fat Oxidation

Zone 2 training — the long, easy, sustained aerobic work described in the [San Millán zone 2 post](/inigo-san-millan-zone-2) — is particularly valuable for metabolic health because it specifically trains your muscles to burn fat for fuel.
...
**Add HIIT for GLUT4 activation.** One to two sessions per week of genuine high-intensity intervals (Tabata, sprint intervals, Norwegian 4×4) maximally activates GLUT4 and produces rapid insulin sensitivity improvements. See the [10-minute workout guide](/10-minute-vo2max-workout) for practical options.
...
And measure your VO2max itself using our [calculator](https://vo2maxcalculators.com) or the [home testing methods](/test-vo2max-at-home). The two sets of numbers together tell a complete story.
...
1. A clear, educational diagram showing the vicious cycle: insulin resistance → mitochondrial dysfunction → low VO2max → impaired fat oxidation → insulin resistance. Arrows forming a downward spiral. Then a second diagram showing exercise breaking the cycle at multiple points. Clean health infographic style.
2. A microscopic-style illustration of a muscle cell with insulin receptors and GLUT4 transporters on the surface — some activated by insulin (glowing green), others activated by exercise (glowing blue). Shows the dual pathway for glucose uptake. Scientific illustration with accessible labeling.
