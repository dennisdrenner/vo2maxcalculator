---
title: "40% Don't Respond to Cardio — Are You One of Them?"
meta_description: "Research shows 40% of people get zero VO2max improvement from months of regular cardio. Learn why it happens and the simple fix that works for almost everyone."
slug: "vo2max-non-responders-cardio"
---

# 40% of People Get Zero Results From Regular Cardio — Are You One of Them?
...
Gibala discusses this in detail in his [landmark interview with Dr. Rhonda Patrick](https://youtube.com/watch?v=anzG6tVdjkQ) (567,000 views). It's a finding that should reframe how we think about exercise prescriptions.
...
...you may be a non-responder to moderate exercise. The [VO2max testing methods](/test-vo2max-at-home) can help you measure whether you're actually improving.
...
This is the most-studied HIIT protocol for VO2max improvement. Research on Norwegian elite athletes (and everyone else) consistently shows large gains. Full breakdown in the [Norwegian training method post](/norwegian-training-method-vo2max).
...
Brutal. Effective. [Rhonda Patrick's preferred method](/rhonda-patrick-vo2max-tabata). Only for people who can push to genuine maximum effort.

## How to Know If It's Working

Test yourself before and after 8 weeks. The [Cooper Test](/test-vo2max-at-home) is the simplest: run as far as you can in 12 minutes on flat ground. Record the distance. Do the test again after 8 weeks of adding high-intensity work.
...
See the full [zone 2 vs. HIIT debate](/zone-2-vs-hiit-debate) for a breakdown of how to balance both.
...
The [10-minute VO2max workout](/10-minute-vo2max-workout) gives you a practical starting point for that one session. Use it.

---
## Suggested Image Prompts
1. An infographic showing two groups of stick figures: the 60% who see VO2max improvement from moderate exercise (happy, upward arrow) and the 40% who don't (frustrated, flat line). Then a second panel showing both groups after adding HIIT — both improving. Clean, clear editorial illustration.
2. A close-up of a person's frustrated face while on a treadmill, treadmill display showing heart rate in moderate range. Visual metaphor for "trying hard but not hard enough." Honest, relatable, slightly darkly humorous.
